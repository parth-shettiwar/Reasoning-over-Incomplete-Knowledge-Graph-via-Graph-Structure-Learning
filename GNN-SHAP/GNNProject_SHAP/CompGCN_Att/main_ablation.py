...
from models_hgt import CompGCN_ConvE
from data_loader_ablation import Data
import numpy as np
...
def main(args):
    ...
    data = Data(args.dataset, args.lbl_smooth, args.num_workers, args.batch_size, args.iep)
    ...
    # with open(f"checkpoints/{args.run_name}/train_loss.json", "w") as f:
    #     json.dump(losses, f)

    # with open(f"checkpoints/{args.run_name}/val_mrr.json", "w") as f:
    #     json.dump(mrrs, f)
