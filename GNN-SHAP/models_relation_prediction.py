...
class CompGCN_ConvE(nn.Module):
    ...
    def forward(self, graph, sub, rel, obj):
        ...
        stk_inp = self.concat(sub_emb, obj_emb)
        ...
        x = F.relu(x)
        #compute score
        x = th.mm(x, r_feats.transpose(1,0))
        #add in bias
